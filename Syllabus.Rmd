...
### Time Commitment
This is a fast paced 1 unit course conducted over 3 weeks. Learning a programming language is not trivial, expect to spend around 10 hours per week for these three weeks if you have never programmed before. 

### Prerequisite
Basic computer literacy. ELM status. 
Review the [Intro to the class](http://norcalbiostat.github.io/R-Bootcamp/lecture_notes/0_1_-_Intro_to_the_class.pdf) slides on instructions on how to install the required programs. 
