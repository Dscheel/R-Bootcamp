...
* Download the [zipped file](https://github.com/norcalbiostat/R-Bootcamp/raw/gh-pages/swirl_lessons.zip) and place it into your `RBootcamp` folder.
...
```{r, eval=FALSE}
library(swirl)
install_course_zip("YOUR PATH HERE/R-Bootcamp/swirl_lessons.zip")
```
