...
```{r, eval=FALSE}
library(swirl)
install_course_zip("YOUR PATH HERE/R-Bootcamp/swirl.zip", 
                   multi=TRUE)
```
...
Ref: [http://osxdaily.com/2013/06/19/copy-file-folder-path-mac-os-x/](http://osxdaily.com/2013/06/19/copy-file-folder-path-mac-os-x/)
...
Ref: [http://ccm.net/faq/31588-windows-8-easily-copy-the-full-path-of-a-file-folder](http://ccm.net/faq/31588-windows-8-easily-copy-the-full-path-of-a-file-folder)

## Using Swirl
That's material for Lab 1!

Go download it from [here](./labs/Lab1_-_Getting_Started_in_R.pdf),put it in your `RBootcamp` folder, double click on it to open it in R Studio and start working on it. 

Don't forget to use the [Piazza](https://piazza.com/account/login) if you get stuck.
