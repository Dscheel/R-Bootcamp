...
2.  Click the save icon, and save this file in your `RBootcamp` folder as `Lab4.R`. 
3.  In the future you will type all of your commands in the code editor window (the window you just opened) and submit them in one of two ways to the console window (the interactive window you have been doing swirl lessons in). 

Let's test out how to submit commands from the editor window, into the console window now. 

1.  Type `2+2` in your script file. 
2.  With your cursor still on the line of code you want to submit, click `Run` in the top left corner of the window. Notice it passes the command on that line to the console window, and excecutes that command. 
3.  With your cursor still on the line of code, press `Ctrl+Enter`. This is simply a keyboard shortcut for the `Run` button. 

If you want to submit multiple lines of code at the same time, you need to highlight all rows to submit before hitting `Run`. 

### Practice

Type the following function in your editor window. Highlight the entire thing and submit it. You won't see any notification if you did it correctly. 
```{r}
...
What does this function do? We will not disucss user defined functions in this class but as you can see they can be pretty easy and useful!
